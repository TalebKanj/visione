...
class AddCommand(ImportCommand, AnalyzeCommand, IndexCommand):
    ...
    def __call__(self, *, video_id, video_path_or_url, replace, **kwargs):
        ...
        video_ids = ImportCommand.__call__(self, video_id=video_id, video_path_or_url=video_path_or_url, gpu=gpu, **common)
        AnalyzeCommand.__call__(self, video_ids=video_ids, gpu=gpu, **common)
        IndexCommand.__call__(self, video_ids=video_ids, **common)